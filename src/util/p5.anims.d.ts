 ...
 */
export function arc(id: string, duration: number, x: number, y: number, w: number, h: number, start: number, stop: number): void;
/**
 ...
 */
export function circle(id: string, duration: number, x: number, y: number, d: number): void;
/**
 ...
 */
export function ellipse(id: string, duration: number, x: number, y: number, w: number, h: number): void;
/**
 ...
 */
export function line(id: string, duration: number, x1: number, y1: number, x2: number, y2: number): void;
/**
 ...
 */
export function newAnimS(p5obj: any): any;
/**
 ...
 */
export function quad(id: string, duration: number, x1: number, y1: number, x2: number, y2: number, x3: number, y3: number, x4: number, y4: number): void;
/**
 ...
 */
export function rect(id: string, duration: number, x: number, y: number, w: number, h: number): void;
/**
 ...
 *     vertices).
 */
export function shape(id: string, duration: number, vertices: Array<Array<number>>): void;
/**
 ...
 */
export function square(id: string, duration: number, x: number, y: number, s: number): void;
/**
 ...
 * @param {!number} y3 The y-coordinate of the third point.
 */
export function triangle(id: string, duration: number, x1: number, y1: number, x2: number, y2: number, x3: number, y3: number): void;
//# sourceMappingURL=p5.anims.d.ts.map